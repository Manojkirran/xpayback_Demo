...
SQLALCHEMY_DATABASE_URL = "postgresql://Manoj:Manoj@123@localhost/demo_db"
...
class User(Base):
    ...
    profile = relationship("Profile", back_populates="UserDemo2")
...
class Profile(Base):
    ...
    user = relationship("UserDemo2", back_populates="profile")
